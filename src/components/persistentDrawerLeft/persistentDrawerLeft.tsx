...
export default function PersistentDrawerLeft(props: IPersistentDrawerLeftProps) {
  ...
  return (
    <Box sx={{ display: "flex" }}>
        ...
        <BlackToolbar>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <Image src={profileName} alt="profile image" width={30} height={30} style={{ borderRadius: "50%" }} />
            </div>
          </Toolbar>
        </BlackToolbar>
      </AppBar>
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", height: 20, gap: 20 }}>
            <PollIcon />
